...
class ProductcomponentItemWidget extends StatefulWidget {
  const ProductcomponentItemWidget({
    super.key,
    this.index,
  ...
  @override
  State<ProductcomponentItemWidget> createState() => _ProductcomponentItemWidgetState();
}

class _ProductcomponentItemWidgetState extends State<ProductcomponentItemWidget> {
  bool isLiked = false;
              ...
              child: Stack(
                ...
                children: [
                  CustomImageView(
                    ...
                    radius: const BorderRadius.only(topLeft: Radius.circular(8), topRight: Radius.circular(8)),
                  ),
                  Padding(
